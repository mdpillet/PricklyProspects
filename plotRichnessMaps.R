...
relPath <- "F:/Chapter1/"
diversityPath <- "Data/DiversityMaps/Summary/"
iucnPath <- "Data/DiversityMaps/IUCN/"
outPath <- "Figures/"
footprintPath <- "Data/HumanFootprint/Dryadv3/Maps/HFP2009.tif"
figPath <- "Figures/"
uncPath <- "Data/UncertaintyRichness/uncertaintyMap.tif"
...
save_plot(paste0(relPath, figPath, "ComparisonModeledIUCN.png"), fig3, ncol = 2)
...
ggsave(paste0(relPath, figPath, "CorrelationModeledIUCN.png"), plotCorr)

# Plot difference maps
diff50 <- f50 - current
writeRaster(diff50, paste0(relPath, diversityPath, "changeAbs_2050-current.tif"))
diff70 <- f70 - current
writeRaster(diff70, paste0(relPath, diversityPath, "changeAbs_2070-current.tif"))
...
writeRaster(diffrel50, paste0(relPath, diversityPath, "changeRel_2050-current.tif"))
diffrel70 <- diff70 / current
writeRaster(diffrel70, paste0(relPath, diversityPath, "changeRel_2070-current.tif"))
...
save_plot(paste0(relPath, figPath, "RichnessChanges.png"), fig4, ncol = 2, nrow = 2)
...
ggsave(paste0(relPath, figPath, "SDCurrent.png"), plotSD)
...
ggsave(paste0(relPath, figPath, "CVCurrent.png"), plotCV)
...
save_plot(paste0(relPath, figPath, "FutureCV.png"), fig5, ncol = 2, nrow = 1)
